                    ...
                    <div class="box">
                      <!--  <div class="pic"><img src="${item.picpath}"></div>-->
                        ...
                        <table>
                            ...
                            <tr><td>就诊时间：</td><td>${item.visitdate}  ${item.visittime}</td></tr>
                            <tr><td>序号：</td><td>${item.serialnumber}号</td></tr>
                            <tr><td>状态：</td><td>${item.state}</td></tr>
                        </table>
<%--                        <c:if test="${item.state=='成功'}">--%>
<%--                            <div class="operate">--%>
<%--                                <div><button type="button"  data-date="${item.visitdate}" data-rid="${item.rid}" data-wid="${item.wid}" class="btn btn-primary btn-xs" style="margin-top: 20px;" data-toggle="modal" data-target="#myModal">--%>
<%--                                    修改预约--%>
<%--                                </button></div>--%>
